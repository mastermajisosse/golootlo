...
List<ConversationModel> conversations = [
  ...
  ConversationModel(
      fullName: 'ayoub mmm',
      image:
          'https://www.epay.com/en/templates/Epay.en/assets/images/avatar.jpg',
      message: 'gheda nmchiw l b7ar',
      date: '3 days ago',
      messageCout: 0),
  ConversationModel(
      fullName: 'rachi test',
      ...
      messageCout: 4),
  ConversationModel(
      fullName: 'yassine yassine',
      image:
          'https://thumbs.dreamstime.com/b/profile-icon-male-avatar-portrait-casual-person-silhouette-face-flat-design-vector-illustration-58249439.jpg',
      message: 'hi',
      date: '11:48 AM',
      messageCout: 0),
  ConversationModel(
      fullName: 'soufiane trick',
      image:
